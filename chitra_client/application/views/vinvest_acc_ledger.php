...
<html lang="en">
    ...
    <body>
        ...
        <div id="view">
            <p class="top_heading">Investment Account Ledger</p>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                function display_data(){
                    ...
                    //to show list for auto complete Deposit Account No Text Box
//                    $('#inv_acc_no').flexbox('deposit_acc_ledger/get_inv_acc_no', { selectBehavior: false, watermark: 'Enter/Select Deposit A/c', paging: true, allowInput: true, autoCompleteFirstMatch: false});
//                    $('#inv_acc_no_ctr').css('width', '300px');
//                    $('#inv_acc_no_input').css('width', '300px');;
                }
                //----------------------------------------------------------------------
				...
				$("#pdf_ledger").button().click(function(){
					if($('#inv_acc_no_hidden').val().length > 1){
                        window.open('<?php echo site_url("deposit_acc_ledger/print_pdf_ledger"); ?>' + '/' + $('#date_filter').val() + '/' + $('#date_filter1').val() + '/' + $('#inv_acc_no_hidden').val(), "Deposit A/c Ledger");
					} else {
						alert("Invalid A/c");
					}
				});
