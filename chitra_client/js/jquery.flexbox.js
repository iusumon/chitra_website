...
(function($) {
    $.flexbox = function(div, o) {
        ...
        .blur(function(e) {
            ...
            setTimeout(function() {
                if (!$input.data('active')) hideResults();
            }, 200);
        })
        ...
        function flexbox(p, arrowOrPagingClicked, prevQuery) {
            //var static prev_parent_object ='';
            
            if (arrowOrPagingClicked) prevQuery = '';
            var q = prevQuery && prevQuery.length > 0 ? prevQuery : $.trim($input.val());
            
            if(typeof flexbox.prev_parent_object == 'undefined'){
                flexbox.prev_parent_object = $(o.parentObject).val();
            }
            ...
            if (q.length >= o.minChars || arrowOrPagingClicked) {
                ...
                //if (cached) {
                if ((cached && !arrowOrPagingClicked && o.selectBehavior)|| (cached && !o.selectBehavior && flexbox.prev_parent_object == $(o.parentObject).val())){
                ...
                
                {
                    ...
                    var qry = q;
                    if (o.selectBehavior) qry = '';
                    if(o.parentObject!=null){ 
                        var v = $(o.parentObject).val();
                        var params = {
                            q: qry, 
                            p: p,
                            v: v, 
